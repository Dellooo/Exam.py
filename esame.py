...
class CSVTimeSeriesFile(CSVFile):
    ...
    def _conversione_data(self, data):
        ...
        converted_data = []
        for line in data:
            converted_line = self._controllo_linea(line)
    ...
    def _controllo_linea(self,line):
        new_line = line
        try:
    ...
    def _controllo_date(self, dates):
    ...
    def get_data(self):
        ...
        data = self._conversione_data(data)
        ...
        dates = self._controllo_date(dates)
...
########################################################################################################################################################################
#!!!!!!!!!!!!METODO E ALGORITMO FONDAMENTALE PER CALCOLARE LA VARIAZIONE MEDIA DEL NUMERO DI PASSEGGERI PER OGNI MESE!!!!!!!!!!!!!!######################################################################################################################################################
...
def compute_avg_monthly_difference(time_series, first_year, last_year):
    ...
    if first_year < 0 or last_year < 0:
        raise ExamException('Errore: anno/i non positivo/i')
...
#print(time_series)
#differenza_media=compute_avg_monthly_difference(time_series,1920,2000)
