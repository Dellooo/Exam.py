...
# classe CSVFile per leggere e memorizzare i dati da un generico file CSV. Vista in classe
...
class CSVFile:
    ...
    def get_data(self):
        # inizializzo una lista vuota 'lines' per salvare tutti i dati
        lines = []
        try:
            #try open file
        ...
        # ottengo il numero di colonne dando per scontato che l'intestazione(1st riga) sia corretta come fatto a lezione
        columns = len(lines[0]) 
        new_lines = []
